...
| migrator.image.tag | string | `"100476-000"` |  |
| migrator.immutable_delegate_docker_image.image.tag | string | `"23.05.79310"` |  |
...
| migrator.version | string | `"1.0.100476"` |  |
...
| verification-svc.image.tag | string | `"79421"` |  |
