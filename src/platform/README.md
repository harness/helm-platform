...
![Version: 0.5.11](https://img.shields.io/badge/Version-0.5.11-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 1.16.1](https://img.shields.io/badge/AppVersion-1.16.1-informational?style=flat-square)
...
| access-control.image.tag | string | `"78001"` |  |
...
| change-data-capture.image.tag | string | `"78431"` |  |
...
| cv-nextgen.image.tag | string | `"78431"` |  |
...
| delegate-proxy.image.tag | string | `"78314"` |  |
...
| gateway.image.tag | string | `"2000188"` |  |
...
| harness-manager.image.tag | string | `"78431"` |  |
| harness-manager.immutable_delegate_docker_image.image.tag | string | `"23.03.78314"` |  |
...
| harness-manager.version | string | `"1.0.78431"` |  |
...
| next-gen-ui.image.tag | string | `"0.339.19"` |  |
...
| ng-manager.image.tag | string | `"78431"` |  |
...
| pipeline-service.image.tag | string | `"1.21.13"` |  |
...
| platform-service.image.tag | string | `"78202"` |  |
...
| template-service.image.tag | string | `"78431"` |  |
...
| verification-svc.image.tag | string | `"78431"` |  |
