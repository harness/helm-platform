...
| change-data-capture.image.tag | string | `"78424"` |  |
...
| cv-nextgen.image.tag | string | `"78424"` |  |
...
| delegate-proxy.image.tag | string | `"78310"` |  |
...
| harness-manager.image.tag | string | `"78424"` |  |
| harness-manager.immutable_delegate_docker_image.image.tag | string | `"23.02.78310"` |  |
...
| harness-manager.version | string | `"1.0.78424"` |  |
...
| ng-manager.image.tag | string | `"78424"` |  |
...
| template-service.image.tag | string | `"78424"` |  |
...
| verification-svc.image.tag | string | `"78424"` |  |
